...
const Sectionthree = () => {
 ...
 ref={scrollTriggerRef}>
  ...
  <p className='text-center text-xl md:text-4xl lg:text-2xl xl:text-3xl'>Services</p>
   ...
   <p className='text-center w-[85%] md:w-[90%] lg:w-[60%] xl:w-[50%] text-xs md:text-2xl lg:text-lg xl:text-xl font-light'> With a focus on excellence and a commitment to innovation, we are here to bring your vision to life.</p>
   </div>
